...
import com.wrathenn.gateway.service.models.HotelShortDto
...
class ReservationsService(
    ...
    fun cancelReservation(username: String, reservationUid: UUID): Unit {
        ...
        val loyalty = loyaltyClient.updateReservationCount(username, LoyaltyReservationCountOperation.DECREMENT)
    }
}